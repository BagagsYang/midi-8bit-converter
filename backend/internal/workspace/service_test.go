...
func TestServiceSaveConfigRoundTripsCanonicalJSON(t *testing.T) {
	...
	expected := `{"layers":[{"curve_enabled":true,"duty":0.5,"frequency_curve":[{"frequency_hz":8.175798915643707,"gain_db":-6.0},{"frequency_hz":12543.853951415975,"gain_db":0.0}],"type":"sine","volume":0.75}],"sample_rate":44100,"schema":"octabit.workspace_config.v1"}`
	if stored != expected {
