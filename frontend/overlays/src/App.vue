      ...
      <div class="workspace-grid">
        <aside class="file-column" :aria-label="t('files.operations')">
          ...
          <OutputControls
            ...
            :queued-files="workspace.queue.value"
            :channel-buses="workspace.channelBuses.value"
            :master-gain-db="workspace.masterGainDb.value"
            :limiter-enabled="workspace.limiterEnabled.value"
            :normalise-enabled="workspace.normaliseEnabled.value"
            ...
            @update-channel-bus-volume="workspace.updateChannelBusVolume"
            @update-channel-bus-mute="workspace.updateChannelBusMute"
            @update-channel-bus-solo="workspace.updateChannelBusSolo"
            @update-master-gain-db="workspace.setMasterGainDb"
            @update-limiter-enabled="workspace.setLimiterEnabled"
            @update-normalise-enabled="workspace.setNormaliseEnabled"
        ...
        <main class="parameter-column" :aria-label="t('parameters.title')">
          <LayerEditor
            ...
            @update-layer-detune="workspace.updateLayerDetune"
