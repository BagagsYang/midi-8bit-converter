...
- Web-specific packages live in `legacy/web-flask/requirements.txt`.
- Retained macOS helper build packages live in `legacy/native/macos/requirements-build.txt`.
