(function () {
     ...
     *
     * Also includes the Hugeicons GitHub icon from https://hugeicons.com/icon/github.
     * Source SVG: https://cdn.hugeicons.com/icons/github-stroke-rounded.svg
     */
    ...
    const hugeiconsAttributes = 'xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true" focusable="false"';
    const icons = {
    ...
    function svg(name, className = 'lucide-icon') {
        ...
        const attributes = name === 'github' ? hugeiconsAttributes : baseAttributes;
        return `<svg class="${className}" ${attributes}>${icons[name]}</svg>`;
    }
